...
- (void)setDictionary:(NSDictionary *_Nullable)dictionary
...
// Number and Booleans are intentionally omitted at the moment because they are
// not needed
